export const ERC1155AdminAbi = [
  ...
  },
  {
    ...
    inputs: [
      { indexed: true, internalType: "uint256", name: "tokenId", type: "uint256" },
      { indexed: false, internalType: "address", name: "saleRecipient", type: "address" },
    ],
  ...
  },
  {
    ...
    outputs: [{ internalType: "enum IPlatformFee.PlatformFeeType", name: "", type: "uint8" }],
    stateMutability: "view",
    type: "function",
  },
  {
  ...
  },
  {
    ...
    outputs: [{ internalType: "uint256", name: "supplyClaimedByWallet", type: "uint256" }],
    stateMutability: "view",
    type: "function",
  },
  {
  ...
  },
  {
    inputs: [
      ...
      { internalType: "address[]", name: "_trustedForwarders", type: "address[]" },
  ...
  {
    inputs: [
      { internalType: "enum IPlatformFee.PlatformFeeType", name: "_feeType", type: "uint8" },
    ],
