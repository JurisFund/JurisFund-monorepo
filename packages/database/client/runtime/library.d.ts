...
export declare type Client = ReturnType<typeof getPrismaClient> extends new () => infer T
  ? T
  : never;
...
export declare const denylist: readonly [
  "$connect",
  "$disconnect",
  "$on",
  "$transaction",
...
> = {
  ...
  $transaction<P extends PrismaPromise_2<any>[]>(
    arg: [...P],
    options?: {
...
> = P extends FluentOperation
  ? DynamicModelExtensionFluentApi<TypeMap, M, P, Null> &
      PrismaPromise_2<DynamicModelExtensionFnResultBase<TypeMap, M, A, P> | Null>
  : PrismaPromise_2<DynamicModelExtensionFnResultBase<TypeMap, M, A, P>>;
  ...
  ? _2 extends unknown
    ? {
        ...
        query: <A extends DynamicQueryExtensionCbArgsArgs<TypeMap, _0, _1, _2>>(
          args: A,
        ) => PrismaPromise_2<TypeMap[_0][_1]["operations"][_2]["result"]>;
      }
    : never
  : never) & {
  query: (
...
export declare type GetFindResult<P extends Payload, A> = Equals<A, any> extends 1
  ? DefaultSelection<P>
  : A extends
      | ({
...
export declare type GetResult_2<
  Base extends Record<any, any>,
  R extends Args_2["result"][string],
...
export declare type InteractiveTransactionOptions<Payload> =
...
export declare type JsonArgumentValue =
  | number
  | string
  | boolean
  | null
...
export declare type JsonQueryAction =
  | "findUnique"
  | "findUniqueOrThrow"
  | "findFirst"
  | "findFirstOrThrow"
...
export declare type PrismaPromiseCallback = (
  transaction?: PrismaPromiseTransaction,
 ...
 * @returns
 */
export declare type PrismaPromiseFactory = (
...
export declare type PrismaPromiseTransaction<PayloadType = unknown> =
...
export declare type QueryMiddleware = (
...
declare namespace Result {
  export { Operation, FluentOperation, GetFindResult, DefaultSelection, GetResult };
}
...
declare namespace Types {
  export { Result, Extensions_2 as Extensions, Utils, Public_2 as Public, Payload };
}
export { Types };
...
>(client: C, model: M, operation: O): <S>(select: Exact<S, Args_3<C[M], O>>) => S;

declare function validator<
  C,
  M extends Exclude<keyof C, `$${string}`>,
  O extends keyof C[M] & Operation,
  P extends keyof Args_3<C[M], O>,
>(client: C, model: M, operation: O, prop: P): <S>(select: Exact<S, Args_3<C[M], O>[P]>) => S;
