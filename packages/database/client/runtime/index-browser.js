  ...
  Ge = (e, n, i, r) => {
    if ((n && typeof n == "object") || typeof n == "function")
      for (let t of We(n))
        !je.call(e, t) &&
          t !== i &&
          he(e, t, { get: () => n[t], enumerable: !(r = Je(n, t)) || r.enumerable });
    return e;
  };
...
d.times = d.mul = function (e) {
  ...
  if (((e.s *= c.s), !h || !h[0] || !g || !g[0]))
    return new a(
      !e.s || (h && !h[0] && !g) || (g && !g[0] && !h) ? NaN : !h || !g ? e.s / 0 : e.s * 0,
    );
  for (
    i = A(c.e / m) + A(e.e / m),
      l = h.length,
...
d.toDecimalPlaces = d.toDP = function (e, n) {
  ...
  return (
    ...
    e === void 0
      ? i
      : (q(e, 0, V), n === void 0 ? (n = r.rounding) : q(n, 0, 8), p(i, e + i.e + 1, n))
  );
};
...
function ie(e, n, i) {
  for (var r, t = [0], s, o = 0, u = e.length; o < u; ) {
    ...
    for (t[0] += we.indexOf(e.charAt(o++)), r = 0; r < t.length; r++)
      t[r] > i - 1 &&
        (t[r + 1] === void 0 && (t[r + 1] = 0), (t[r + 1] += (t[r] / i) | 0), (t[r] %= i));
  }
  return t.reverse();
}
function en(e, n) {
          ...
          (h = 0),
            ...
            f < 0
              ? ((x = E[0]),
                ...
                i(E, N, P, l),
                f == -1 &&
                  ((P = E.length), (f = n(k, E, L, P)), f < 1 && (h++, i(E, L < P ? y : k, P, l))),
                (P = E.length))
              : f === 0 && (h++, (E = [0])),
            (T[a++] = h),
...
function Se(e, n) {
  ...
  if (((n = n.slice(r, t)), n)) {
    if (
      ((t -= r), (e.e = i = i - r - 1), (e.d = []), (r = (i + 1) % m), i < 0 && (r += m), r < t)
    ) {
      ...
      if (
        ...
        (f =
          r < 4
            ...
            : o > u ||
              (o === u && (r === 4 || f || (r === 6 && a[i - 1] & 1) || r === (e.s < 0 ? 8 : 7)))),
        (a.length = i),
        f)
      )
...
function Ln(e) {
  ...
  if ((e === void 0 ? (e = this.precision) : q(e, 1, V), (r = Math.ceil(e / m)), this.crypto))
    if (crypto.getRandomValues)
      for (n = crypto.getRandomValues(new Uint32Array(r)); s < r; )
        (t = n[s]),
          t >= 429e7 ? (n[s] = crypto.getRandomValues(new Uint32Array(1))[0]) : (u[s++] = t % 1e7);
  ...
  for (
    r = u[--s], e %= m, r && e && ((t = M(10, m - e)), (u[s] = ((r / t) | 0) * t));
    u[s] === 0;
    s--
  )
    u.pop();
